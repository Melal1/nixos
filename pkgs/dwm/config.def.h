...
static const char *fonts[]          = { "FiraCode Nerd Font:style=SemiBold:size=10","Noto Naskh Arabic:style=SemiBold:size=12" };
...
static const char gray[] = "#404040";
static const char fg_li[] = "#a6a6a6";
static const char fg_dr[] = "#939393";


static const char *colors[][3]      = {
	/*               fg         bg         border   */
	[SchemeNorm] = { fg_dr, black, black },
	[SchemeSel]  = { fg_li, gray,  fg_li  },
};
